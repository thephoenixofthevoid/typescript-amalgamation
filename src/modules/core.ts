import { MapLike, __String, SortedReadonlyArray, SortedArray, ReadonlyESMap, Iterator, ESMap, Comparer, Comparison, Push, EqualityComparer, Pattern, TextSpan, Set } from "./types";
